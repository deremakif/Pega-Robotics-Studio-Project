using SUA_prj_SUA_Win_Form = SUA_prj.SUA_Win_Form;

using SUA_prj_TCMB = SUA_prj.TCMB;

using SUA_prj_TCMB_Web_App = SUA_prj.TCMB_Web_App;

using SUA_prj_Go_To_Idefix_Web_App = SUA_prj.Go_To_Idefix_Web_App;

using SUA_prj_CreatingExcel = SUA_prj.CreatingExcel;

using SUA_prj_SendingExcel = SUA_prj.SendingExcel;

using SUA_prj_GoToIdefix = SUA_prj.GoToIdefix;

using SUA_prj_Main_Automation = SUA_prj.Main_Automation;

using SUA_prj_Timer = SUA_prj.Timer;
...
public sealed class SUA_prj : OpenSpan.Runtime.RuntimeProject
{
	...
	public SUA_prj(System.ComponentModel.ISynchronizeInvoke syncObject) : 
			base(syncObject)
	{
		// 
		// Global Initialization
	...
	public SUA_prj(System.IServiceProvider serviceProvider) : 
	...
	public SUA_prj(bool initializeScout) : 
	...
	private SUA_prj(System.IServiceProvider serviceProvider, OpenSpan.Runtime.RuntimeHostCommandLineHelper commandLineHelper, OpenSpan.Deployment.DeploymentManifest deploymentManifest) : 
	...
	private void SUA_prj_Initialize()
	{
	...
	public SUA_prj_SUA_Win_Form SUA_Win_Form
	{
		get
		{
			return ((SUA_prj_SUA_Win_Form)(this["SUA_Win_Form"]));
		}
	}
	
	// Automator-8D6717AC7C90255
	public SUA_prj_TCMB TCMB
	{
		get
		{
			return ((SUA_prj_TCMB)(this["TCMB"]));
		}
	}
	
	// WebAdapter-8D6717AD8E97EBA
	public SUA_prj_TCMB_Web_App TCMB_Web_App
	{
		get
		{
			return ((SUA_prj_TCMB_Web_App)(this["TCMB_Web_App"]));
		}
	}
	
	// WebAdapter-8D670B793CEFB2B
	public SUA_prj_Go_To_Idefix_Web_App Go_To_Idefix_Web_App
	{
		get
		{
			return ((SUA_prj_Go_To_Idefix_Web_App)(this["Go_To_Idefix_Web_App"]));
		}
	}
	
	// Automator-8D671930320A4A1
	public SUA_prj_CreatingExcel CreatingExcel
	{
		get
		{
			return ((SUA_prj_CreatingExcel)(this["CreatingExcel"]));
		}
	}
	
	// Automator-8D6716D6E8DB7D5
	public SUA_prj_SendingExcel SendingExcel
	{
		get
		{
			return ((SUA_prj_SendingExcel)(this["SendingExcel"]));
		}
	}
	
	// Automator-8D6717DB4E9B50B
	public SUA_prj_GoToIdefix GoToIdefix
	{
		get
		{
			return ((SUA_prj_GoToIdefix)(this["GoToIdefix"]));
		}
	}
	
	// Automator-8D670B5D2D22CA8
	public SUA_prj_Main_Automation Main_Automation
	{
		get
		{
			return ((SUA_prj_Main_Automation)(this["Main_Automation"]));
		}
	}
	
	// Automator-8D6716EED22BBAA
	public SUA_prj_Timer Timer
	{
		get
		{
			return ((SUA_prj_Timer)(this["Timer"]));
		}
	}
}
